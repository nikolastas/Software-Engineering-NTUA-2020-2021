...
2. Write to following in bash terminal:
...
Command: ```admin --usermood --username <username> --password <new password>```
...
```
### 12. admin signup 
Command: ```admin --usermood --username <username> --password <password> --typeofuser <admin or user>```
